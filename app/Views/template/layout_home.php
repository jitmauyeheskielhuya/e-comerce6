        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full self-end px-4 lg:w-1/2">
            <div class="relative mt-10 lg:mt-0 lg:right-0">
              <img src="dist/img/ekel.png" alt="ekel" class="max-w-full mx-auto relative z-10">
        ...
        <div class="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
          <div class="mb-12 p-4 md:w-1/2">
            <div class="rounded-md shadow-md overflow-hidden dark:shadow-slate-500">
              <img src="dist/img/portfolio/4.jpg" alt="portfolio botstrap5" width="w-full">
            </div>
          ...
          <div class="mb-12 p-4 md:w-1/2">
            <div class="rounded-md shadow-md overflow-hidden dark:shadow-slate-500">
              <img src="dist/img/portfolio/6.jpg" alt="belajar tailwindcss" width="w-full">
            </div>
          ...
          <div class="mb-12 p-4 md:w-1/2">
            <div class="rounded-md shadow-md overflow-hidden dark:shadow-slate-500">
              <img src="dist/img/portfolio/5.jpg" alt="css project" width="w-full">
            </div>
          ...
          <div class="mb-12 p-4 md:w-1/2">
            <div class="rounded-md shadow-md overflow-hidden dark:shadow-slate-500">
              <img src="dist/img/portfolio/2.jpg" alt="portfolio sederhana" width="w-full">
            </div>
          ...
          <div class="mb-12 p-4 md:w-1/2">
            <div class="rounded-md shadow-md overflow-hidden dark:shadow-slate-500">
              <img src="dist/img/portfolio/3.jpg" alt="portfolio sederhana" width="w-full">
            </div>
            <h3 class="font-semibold text-xl text-dark mt-5 mb-3 dark:text-white">Portfolio Sederhana Yeheskiel Jitmau
            </h3>
            <p class="font-medium text-base text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit.
          ...
          <div class="mb-12 p-4 md:w-1/2">
            <div class="rounded-md shadow-md overflow-hidden dark:shadow-slate-500">
              <img src="dist/img/portfolio/1.jpg" alt="css project" width="w-full">
            </div>
        ...
        <div class="w-full px-4">
          <div class="flex flex-wrap items-center justify-center">
            <a href="#" class="max-w-[120px] mx-4 py-4 grayscale opacity-60 transition duration-500 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8">
              <img src="./dist/img/clients/Google_2015_logo.svg.png" alt="google">
            </a>
            <a href="#" class="max-w-[120px] mx-4 py-4 grayscale opacity-60 transition duration-500 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8">
              <img src="./dist/img/clients/Gojek_logo_2019.svg.png" alt="goojek">
            </a>
            <a href="#" class="max-w-[120px] mx-4 py-4 grayscale opacity-60 transition duration-500 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8">
              <img src="./dist/img/clients/Tokopedia.svg.png" alt="tokopedia">
            </a>
            <a href="#" class="max-w-[120px] mx-4 py-4 grayscale opacity-60 transition duration-500 hover:grayscale-0 hover:opacity-100 lg:mx-6 xl:mx-8">
              <img src="./dist/img/clients/traveloka_logo.png" alt="traveloka">
            </a>
          </div>
        </div>
      </div>
