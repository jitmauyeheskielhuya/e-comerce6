        ...
        <div class="w-full pt-4">
          <div class="container mx-auto py-8 bg-slate-200 rounded-md shadow-md mb-16">
            ...
            <div class="w-64 mx-auto mt-4">
              <label class="block mb-2 font-bold text-emerald-400" for="ukuran-noken">Ukuran Noken:</label>
            ...
            <div class="w-64 mx-auto mt-4">
              <label class="block mb-2 font-bold text-emerald-400" for="jenis-noken">Jenis Noken:</label>
              <select id="jenis-noken" name="jenis_noken" class="w-full px-4 py-2 border border-gray-300 rounded-lg mb-5">
                <option value="">Pilih Jenis Noken</option>
